...
//    private Bitmap addBottomLogo(Context context, Bitmap src) {
//        int width = src.getWidth();
//        int height = src.getHeight();
//
//        Bitmap bitmap = Bitmap.createBitmap(width + dip2px(50), height + dip2px(50), Bitmap.Config.ARGB_8888);
//
//        Canvas canvas = new Canvas(bitmap);
//        canvas.drawBitmap(src, 0, 0, null);
//
//        Bitmap  logo = BitmapFactory.decodeResource(context.getResources(), R.mipmap.ic_launcher);
//        canvas.drawBitmap(logo, width, height, null);
//        canvas.save(Canvas.ALL_SAVE_FLAG);
//        canvas.restore();
//        return bitmap;
//    }
